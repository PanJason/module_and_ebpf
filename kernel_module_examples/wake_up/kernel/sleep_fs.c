// create a /proc file, and if several processes try to open it
...
static int module_open(struct inode *inode, struct file *file)  
{
    ...
    while (atomic_cmpxchg(&already_open, 0, 1)) {  
        ...
        // is closed) or when a signal, such as Ctrl-C, is sent to the process
...
MODULE_DESCRIPTION("A simple example to create a /proc file and put processes to sleep");
MODULE_VERSION("1.0");
